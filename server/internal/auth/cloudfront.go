...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.myteam.ai"
	cookieDomain string // cookie scope, e.g. ".myteam.ai"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.myteam.ai")
//   - COOKIE_DOMAIN           (e.g. ".myteam.ai")
