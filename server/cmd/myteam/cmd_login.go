...
var loginCmd = &cobra.Command{
	...
	Long:  "Log in to MyTeam, then automatically discover and watch all your workspaces.",
	RunE:  runLogin,
}
...
func runLogin(cmd *cobra.Command, args []string) error {
	...
	if err := autoWatchWorkspaces(cmd); err != nil {
		...
		fmt.Fprintf(os.Stderr, "Run 'myteam workspace list' and 'myteam workspace watch <id>' to set up manually.\n")
		return nil
	}

	fmt.Fprintf(os.Stderr, "\n→ Run 'myteam daemon start' to start your local agent runtime.\n")
	return nil
}
