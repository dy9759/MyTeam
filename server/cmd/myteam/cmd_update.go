...
var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update myteam to the latest version",
	RunE:  runUpdate,
}
...
func runUpdate(_ *cobra.Command, _ []string) error {
	...
	if cli.IsBrewInstall() {
		...
		if err != nil {
			...
			return fmt.Errorf("brew upgrade failed: %w\nYou can try updating the package manually with your package manager", err)
		}
	...
	if latest == nil {
		return fmt.Errorf("could not determine latest version; check the latest MyTeam release manually")
	}
